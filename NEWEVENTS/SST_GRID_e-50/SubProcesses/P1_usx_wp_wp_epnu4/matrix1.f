...
C     
C     Process: u s~ > w+ BSM<=1 WEIGHTED<=2 HIG<=1 HIW<=1 @1
C     *   Decay: w+ > e+ nu4 BSM<=1 WEIGHTED<=2 HIW<=1 HIG<=1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     BEGIN CODE
C     ----------
      CALL IXXXXX(P(0,1),MDL_MU1,NHEL(1),+1*IC(1),W(1,1))
      CALL OXXXXX(P(0,2),MDL_MD2,NHEL(2),-1*IC(2),W(1,2))
      CALL IXXXXX(P(0,3),MDL_ME1,NHEL(3),-1*IC(3),W(1,3))
      CALL OXXXXX(P(0,4),MDL_MNU4,NHEL(4),+1*IC(4),W(1,4))
      CALL FFV3_3(W(1,3),W(1,4),GC_462,MDL_MWP,MDL_WWP,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV3_0(W(1,1),W(1,2),W(1,5),GC_346,AMP(1))
